...
var adaptiveWords = []string{
	...
	"even", "new", "want", "because", "any", "these", "give", "day", "most", "us", "typing", "practice", "quick", "brown", "fox",
	"jumps", "lazy", "dog", "pack", "box", "five", "dozen", "liquor", "jugs", "vexingly", "daft", "zebras",
	"hello", "world", "welcome", "each", "word", "carefully", "accuracy", "keyboard", "skills", "improve", "daily",
	"cat", "sat", "mat", "near", "door", "sells", "seashells", "seashore", "stitch", "saves", "nine",
	"birds", "feather", "flock", "together", "actions", "speak", "louder", "words", "things", "wait",
	"apple", "keeps", "doctor", "away", "beauty", "eye", "beholder", "better", "never", "curiosity", "killed",
	"count", "chickens", "hatch", "cloud", "silver", "lining", "fortune", "favors", "bold", "brave",
	"great", "minds", "alike", "honesty", "best", "policy", "knowledge", "power", "life", "make",
	"reap", "sow", "early", "bird", "catches", "worm", "penny", "earned", "heads", "steady", "wins", "race",
	"health", "wealth", "reading", "expands", "mind", "soul", "writing", "helps", "clearly", "faster", "comes",
	"layouts", "vary", "region", "matters", "speed", "warm", "fingers", "breaks", "avoid", "strain",
	"ergonomics", "comfort", "touch", "muscle", "memory", "home", "row", "anchor", "picture", "worth", "thousand",
	"break", "leg", "performance", "bite", "bullet", "face", "fears", "nail", "head", "answer",
	"once", "blue", "moon", "snow", "piece", "cake", "test", "easy", "raining", "cats", "dogs", "outside", "today",
	"spill", "beans", "tell", "everything", "ball", "court", "under", "weather", "feeling", "unwell",
	"drawing", "board", "cutting", "corners", "cost", "later", "eventually", "act", "please", "ground", "running", "morning",
	"same", "boat", "let", "bag", "pain", "gain", "page", "finally", "pull", "yourself", "straw", "broke", "camel",
	"thick", "thin", "pigs", "fly", "happen", "jackpot", "congratulations", "dear", "blessing", "disguise", "really",
	"bread", "butter", "business", "cold", "shoulder", "diamond", "rough", "found", "drop", "bucket", "much",
	"eleventh", "hour", "decision", "always", "full", "beans", "green", "envy", "clouds", "dreaming",
	"heart", "gold", "icing", "perfect", "jump", "bandwagon", "keep", "chin", "friend", "long", "story", "short", "agreed",
	"miss", "late", "needle", "haystack", "impossible", "happy", "right", "rain", "shot", "dark", "guess",
	"thorn", "side", "tip", "iceberg", "air", "uncertain", "journey", "miles", "begins", "single", "step",
	"patience", "bitter", "fruit", "sweet", "success", "final", "failure", "fatal", "travel", "arrive",
	"great", "love", "middle", "difficulty", "opportunity", "busy", "plans", "plant", "tree", "twenty", "years",
	"path", "lead", "instead", "miss", "hundred", "percent", "shots", "impossible", "never", "begin",
	"lies", "behind", "before", "tiny", "matters", "believe", "halfway", "nature", "peaceful", "escape", "stresses",
	"walking", "woods", "sea", "clear", "many", "solace", "sounds", "waves", "nutrition", "foundation", "healthy",
	"balanced", "meals", "vegetables", "support", "body", "hydrated", "limit", "processed", "foods",
	"sleep", "essential", "physical", "mental", "recovery", "seven", "eight", "hours", "quality", "rest", "night",
	"consistent", "schedule", "regulate", "clock", "friendship", "enriches", "countless", "ways",
	"true", "friends", "celebrate", "successes", "support", "difficult", "invest", "relationships", "joy", "growth",
	"technology", "changed", "communicate", "email", "messaging", "replaced", "letter", "writing",
	"foundation", "touch", "anchored", "reach", "return", "priorities", "exercise", "regularly", "eat",
	"enough", "thank", "learning", "stops", "age", "sharp", "engaged", "embrace", "grow",
	"virtue", "situations", "rushing", "leads", "mistakes", "right", "doing", "helps", "editor", "start",
	"habits", "lifetime", "small", "efforts", "compound", "stick", "prevent", "injury", "position", "monitor",
	"future", "slow", "build", "rhythm", "flow", "fascinating", "history", "typewriters", "modern", "mechanical",
	"keys", "design", "shaped", "walking", "woods", "peaceful", "balanced", "vegetables", "hydrated",
	...
	"law", "lawyer", "lay", "lead", "leader", "learn", "learning", "least", "leave", "left",
	...
	"need", "network", "never", "new", "news", "newspaper", "next", "nice", "night", "nine",
	...
	"own", "owner", "page", "pain", "painting", "pair", "paper", "parent", "part", "participant",
